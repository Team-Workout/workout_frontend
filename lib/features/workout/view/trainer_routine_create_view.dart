                              ...
                              onExerciseSelected: (selectedExercise) {
                                setState(() {
                                  _selectedExercises[exerciseIndex] =
                                      selectedExercise;
                                  _exerciseControllers[exerciseIndex]!.text =
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 6),
                      TextFormField(
                        initialValue: set.weight == 0.0 ? '0' : set.weight.toString(),
                        decoration: InputDecoration(
                          hintText: '0',
                          filled: true,
                        ...
                        onChanged: (value) {
                          ...
                          setState(() {
                            final exercise = _routineExercises[exerciseIndex];
                            final sets =
                                List<RoutineSet>.from(exercise.routineSets);
                            sets[setIndex] =
                        ...
                        onChanged: (value) {
                          ...
                          setState(() {
                            ...
                            final sets =
                                List<RoutineSet>.from(exercise.routineSets);
                            sets[setIndex] =
                                sets[setIndex].copyWith(reps: reps);
                            _routineExercises[exerciseIndex] =
                                exercise.copyWith(routineSets: sets);
                          });
                        },
