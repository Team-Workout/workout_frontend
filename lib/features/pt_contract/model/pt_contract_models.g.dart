...
_$PtAppointmentProposalImpl _$$PtAppointmentProposalImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$PtAppointmentProposalImplToJson(
        _$PtAppointmentProposalImpl instance) =>
    <String, dynamic>{
      'contractId': instance.contractId,
...
_$PtAppointmentScheduleImpl _$$PtAppointmentScheduleImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$PtAppointmentScheduleImplToJson(
        _$PtAppointmentScheduleImpl instance) =>
    <String, dynamic>{
      'contractId': instance.contractId,
      'startTime': instance.startTime,
      'endTime': instance.endTime,
